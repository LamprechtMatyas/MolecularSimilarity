...
extended-connectivity fingerprints and computing similarity by using
...
input model_configuration should look like this:
    {"model_name": "rdkit_ecfp_model", "fragments": "ecfp.num1"}
    num1 is a diameter of ECFP
"""
...
register_model(RdkitEcfpModel.model_name, lambda: RdkitEcfpModel())
