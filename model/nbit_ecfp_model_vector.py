...
Then it uses Tanimoto similarity metrics.
    {"model_name": "nbit_ecfp_model_vector", "fragments": "ecfp.num1", "nbits": num}
...
class NbitEcfpModelVector(IModel):
    ...
    def score_model(self, model_configuration: dict, fragments_file: str,
        ...
        for active_molecule in model_data["active"]:
            ...
            ecfp_fingerprint = AllChem.GetMorganFingerprintAsBitVect(molecule, radius, nBits=nbits)
        ...
        with open(output_file, "w", encoding="utf-8") as output_stream:
            with open(fragments_file, "r", encoding="utf-8") as input_stream:
                for new_line in input_stream:
                    ...
                    test_mol_fingerprint = AllChem.GetMorganFingerprintAsBitVect(test_molecule,
                                                                                 radius, nBits=nbits)
